...
$test = '../../' . $output_prof[4] . '/' . $output_prof[5] . '/' . $output_prof[6];
 ?>
<!DOCTYPE html>
<html>
<head></head>
...
<link rel="stylesheet" type="text/css" href="..\..\resources\assets\css\profile_preview.css"/>
...
{{--on p.album_id= a.id WHERE p.user_id IN ('$id')--}}
...
<div class="rela-block container" id="haha">
 <div class="rela-block profile-card">
  ...
  <div class="rela-block profile-name-container">
   ...
   <div class="rela-block user-desc" id="user_description">{{$user->description}}</div>
   <a href="..\followers"> <div class="floated profile-stat followers" id="num_followers"><?= $followers_count ?> <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span><br></div></a>
   <a href="..\followings"> <div class="floated profile-stat following" id="num_following"><?= $followings_count ?> <span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span><br></div></a>

  </div>
  <div class="rela-block profile-card-stats" style="margin-left: 13em;">
   {{-- <div class="floated profile-stat user-name" id="num_works">{{$user->username}}<br>
    </div>--}}
   <a href="..\followers"> <div class="floated profile-stat followers" id="num_followers"><?= $followers_count ?> <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span><br></div></a>
   <a href="..\followings"> <div class="floated profile-stat following" id="num_following"><?= $followings_count ?> <span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span><br></div></a>
...
<div class="album text-muted">
 <div class="container" >
  ...
  <div class="row">
      ...
      $postove = DB::select("SELECT u.firstname, u.lastname,u.profile_pic,u.id as uid,p.id as pid,p.photo,p.text,p.created_at,p.location,a.name,p.created_at , a.id as aid FROM
  ...
  .profile-pic{
   background: url(<?= $test ?>) center no-repeat;
